...
BURIQ () {
    curl -sS  https://raw.githubusercontent.com/Manpokr/m/main/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/Manpokr/m/main/ip | grep $MYIP | awk '{print $2}')
