...
BURIQ () {
    curl -sS  https://raw.githubusercontent.com/Manpokr/ip/main/Ipc > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/Manpokr/ip/main/Ipc | grep $MYIP | awk '{print $2}')
